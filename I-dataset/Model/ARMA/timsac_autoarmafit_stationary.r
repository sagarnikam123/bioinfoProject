#calculates TIM-SAC autoarmafit(p,q)order/arma model for stationary models only

rm(list=ls())                                  
library(timsac)  #adding itsmr package


faana<-read.table("C:\\Users\\msc2\\Desktop\\Halwa\\BADMASHI\\Model\\ARMA\\Autofit_arma_stationary.txt",skip=1)  #file path for r values
madhur<-as.character(faana$V1)   #takes only stationary file ids
