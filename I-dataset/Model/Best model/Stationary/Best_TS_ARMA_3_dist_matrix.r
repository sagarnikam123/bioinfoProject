#calculates distance matrix for BEST auto.ARMA_3 TS of Stationary processes

rm(list=ls())

seq<-read.table("C:\\Users\\msc2\\Desktop\\Halwa\\BADMASHI\\Model\\Best model\\Stationary\\Best_stationary_3\\Best_stationary_ARMA_3.txt",skip=1)
...
write.table(agar,"C:\\Users\\msc2\\Desktop\\Halwa\\BADMASHI\\Model\\Best model\\Stationary\\Best_stationary_3\\Best_stat_TS_dist_matrix\\Best_stat_ARMA_3_TS_dist_matrix.txt",col.names=F)

#for making dist matrix table
library(stringr)      #for string manipulation(right padding/blankspaces)

fileConn<-file("C:\\Users\\msc2\\Desktop\\Halwa\\BADMASHI\\Model\\Best model\\Stationary\\Best_stationary_3\\Best_stat_TS_dist_matrix\\Best_stat_ARMA_3_TS_phylip_dist.txt","a")  #opening file connection (appending mode)
