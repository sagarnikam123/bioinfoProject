#calculates distance matrix  for Best_AR_3_stationary_TS_models
rm(list=ls())
                           

room<-read.table("C:\\Users\\msc2\\Desktop\\Halwa\\BADMASHI\\Model\\Best_model\\Stationary\\Best_stationary_3\\Best_stationary_AR_3.txt",skip=1)     #opens BEST_AR_AIC file
...
write.table(agar,"C:\\Users\\msc2\\Desktop\\Halwa\\BADMASHI\\Model\\Best_model\\Stationary\\Best_stationary_3\\Best_stat_AR_3\\Best_AR_dist_TS_3.txt",col.names=F)
                                                      
#for making dist matrix table
library(stringr)      #for string manipulation(right padding/blankspaces)

fileConn<-file("C:\\Users\\msc2\\Desktop\\Halwa\\BADMASHI\\Model\\Best_model\\Stationary\\Best_stationary_3\\Best_stat_AR_3\\Best_AR_dist_TS_3_protdist.txt","a")  #opening file connection (appending mode)
